    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      <div className="card relative w-full max-w-md animate-fade-in">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-[hsl(var(--text-secondary))]">Proteja sua rede em minutos</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-1.5 block text-sm text-[hsl(var(--text-secondary))]">Senha (mín. 8 caracteres)</label>
        ...
        <p className="mt-6 text-center text-sm text-[hsl(var(--text-secondary))]">
          Já tem conta?{' '}
          <Link href="/login" className="font-medium text-emerald-400 hover:underline">Entrar</Link>
        </p>
      </div>
    </div>
  );
